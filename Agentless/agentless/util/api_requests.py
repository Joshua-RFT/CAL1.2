...
def num_tokens_from_messages(message, model="gpt-3.5-turbo-0301"):
    ...
    try:
        ...
        #print('#encoding = tiktoken.encoding_for_model(model)#',encoding,'##')
    except KeyError:
...
#Deyudada：api替换
    ...
    client = openai.OpenAI(base_url=os.environ.get("OPENAI_API_URL"))
    #client = openai.OpenAI(base_url='https://api.vveai.com/v1')
    #client = openai.OpenAI(base_url='https://lonlie.plus7.plus/v1')
